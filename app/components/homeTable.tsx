...
export default function HomeTable() {
  return (
    <div className="bg-white">
      <h2 className="px-4 py-4 font-semibold text-gray-900 sm:px-6 lg:px-8">
        Countries List
      </h2>
              ...
              <td className="py-4 pr-4 pl-0 text-sm/6 sm:pr-8 lg:pr-20">
                <div className="flex items-center justify-end gap-x-2 sm:justify-start">
                  ...
                  {item.status === "Completed" ? (
                    <div className="flex-none rounded-full bg-green-600/10 p-1 text-green-600">
                      <div className="size-1.5 rounded-full bg-current" />
                    </div>
                  ) : null}
                  {item.status === "Error" ? (
                    <div className="flex-none rounded-full bg-rose-600/10 p-1 text-rose-600">
                      <div className="size-1.5 rounded-full bg-current" />
                    </div>
                  ) : null}
